...
class ProductManualInputPrice
{
     ...
     */
    public function recalculateInputPriceForNewVatPercent($inputPriceType, BasePriceCalculation $basePriceCalculation, InputPriceCalculation $inputPriceCalculation, $newVatPercent)
    {
